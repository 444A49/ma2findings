...
Following parameters are available on version 01.00.0250

## Diff with previous version (01.00.0130)

```
< battery_type default = 1 range = < 0 .. 3 >
---
> battery_type default = 1 range = < 1 .. 1 >
```

This will prevent you from disabling forced landings.

```
< sop_type default = 3 range = < 0 .. 255 >
---
> sop_type default = 3 range = < 3 .. 3 >
```

No clue what is disabled with this.

## Diff with next version (01.00.0340)

```
< user_avoid_enable|g_config.avoid_obstacle_limit_cfg.user_avoid_enable default = 1 range = < 0 .. 1 >
---
> user_avoid_enable|g_config.avoid_obstacle_limit_cfg.user_avoid_enable default = 1 range = < 0 .. 2 >
```

Looks related to the new type of obstacle bypass (climb, surround, stop?)

```
> forbid_side_fly default = 0 range = < 0 .. 1 >
```

Disables the left/right control (MA2 has no side obstacle avoidance)

```
> rc_lost_delay_time_for_timelapse default = 0.000000 range = < 0.000000 .. 1000000000.000000 >
> gimbal_fpv_mode_enable default = 0 range = < 0 .. 1 >
> fpv_roll_follow_enable default = 0 range = < 0 .. 1 >
> fpv_roll_pitch_fltr_fc default = 0.750000 range = < 0.010000 .. 20.000000 >
> fpv_yaw_fltr_fc default = 10.000000 range = < 0.010000 .. 20.000000 >
> fpv_roll_max default = 20.000000 range = < 0.100000 .. 50.000000 >
> fpv_r_p_rate_max default = 180.000000 range = < 0.100000 .. 500.000000 >
> fpv_r_comp_exp default = 0.800000 range = < 0.100000 .. 0.900000 >
```

No clue

```
< go_home_current default = 7500 range = < 0 .. 65535 >
---
> go_home_current default = 7800 range = < 0 .. 65535 >
```

No clue

```
< g_config.mode_sport_cfg.tors_exp_mid_point default = 0.350000 range = < 0.100000 .. 0.900000 >
---
> g_config.mode_sport_cfg.tors_exp_mid_point default = 0.250000 range = < 0.100000 .. 0.900000 >
```
...
atti_gain default = 114 range = < 80 .. 200 >
atti_tilt_comp_fc default = 8.260000 range = < 0.010000 .. 150.000000 >
atti_tilt_comp_gain default = 5.610000 range = < 0.010000 .. 150.000000 >
ang_vel_tilt_pi_freq default = 0.449000 range = < 0.010000 .. 150.000000 >
ang_vel_tilt_comp_fc default = 3.220000 range = < 0.010000 .. 150.000000 >
power_bandwidth default = 100 range = < 30 .. 150 >
ang_vel_tilt_comp_gain default = 31.200001 range = < 0.010000 .. 150.000000 >
g_config.mr_ctrl.ctrl_lowpass_fp default = 50.000000 range = < 0.010000 .. 150.000000 >
g_config.mr_ctrl.ctrl_lowpass_fz default = 90.000000 range = < 0.010000 .. 150.000000 >
...
horiz_vel_gain|g_config.control.horiz_vel_p_gain default = 115 range = < 20 .. 250 >
vert_vel_gain default = 120 range = < 0 .. 500 >
...
ns_multi_fdi_open default = 1 range = < 0 .. 1 >
ns_multi_w_fdi_open default = 0 range = < 0 .. 1 >
ns_multi_ag_fdi_open default = 1 range = < 0 .. 1 >
ns_multi_vg_fdi_open default = 1 range = < 0 .. 1 >
ns_multi_alti_fdi_open default = 1 range = < 0 .. 1 >
...
fit_test_enable default = 0 range = < 0 .. 1 >
...
ultrasonic_fdi_open_stuck default = 0 range = < 0 .. 1 >
ultrasonic_fdi_open_disconnect default = 0 range = < 0 .. 1 >
...
vo_fdi_open_stuck_vel default = 0 range = < 0 .. 1 >
...
g_config.fdi_switch.ns.default_index default = 1 range = < 0 .. 5 >
...
typical_case default = 0 range = < 0 .. 4294967295 >
SIM_GPS_DATE default = 201509060 range = < 0 .. 4294967295 >
SIM_GPS_TIME default = 0 range = < 0 .. 4294967295 >
sim_vo_omni_avoid_raw_data_enable default = 0 range = < 0 .. 1 >
sim_radar_omni_avoid_raw_data_enable default = 0 range = < 0 .. 1 >
...
g_status.user_info.statistical_info.total_fly_times default = 0 range = < 0 .. 4294967295 >
...
g_status.user_info.statistical_info_last.total_fly_times default = 0 range = < 0 .. 4294967295 >
g_status.battery.raw_info.capacity_percentage default = 0 range = < 0 .. 255 >
battery_status default = 20 range = < 0 .. 4294967295 >
motor_fail_for_mission_degrade_en default = 0 range = < 0 .. 1 >
first_takeoff_warning default = 1 range = < 0 .. 1 >
has_shown_check_warning default = 0 range = < 0 .. 1 >
check_fc_stability default = 0 range = < 0 .. 1 >
...
enable_multiple_mode|g_config.control.multi_control_mode_enable default = 1 range = < 0 .. 1 >
...
avoid_atti_range default = 20 range = < 10 .. 60 >
wind_anti_intensity|g_config.control.wind_anti_intensity default = 100 range = < 20 .. 100 >
brake_sensitive_fc|g_config.control.brake_sensitivity_fc default = 0.600000 range = < 0.000000 .. 2.000000 >
brake_sensitive_gain|g_config.control.brake_sensitivity default = 100 range = < 80 .. 150 >
emergency_brake_sensitive default = 0.800000 range = < 0.000000 .. 2.000000 >
vert_vel_down_adding|g_config.control.vert_vel_down_adding default = 2 range = < 0 .. 5 >
vert_vel_down_adding_max default = -5.000000 range = < -10.000000 .. 0.000000 >
g_config.misc_cfg.gimbal_priority_en default = 0 range = < 0 .. 1 >
g_config.misc_cfg.follow_gimbal_yaw_when_watch|g_cfg_debug.follow_gimbal_yaw_when_watch default = 0 range = < 0 .. 1 >
...
sport_ffg_speed_ctrl_perc|g_config.control.sport_ffg_speed_ctrl_perc default = 0 range = < 0 .. 100 >
trip_ffg_speed_ctrl_perc|g_config.control.trip_ffg_speed_ctrl_perc default = 8 range = < 0 .. 100 >
api_ffg_speed_ctrl_perc|g_config.control.api_ffg_speed_ctrl_perc default = 0 range = < 0 .. 100 >
prop_cover_cfg.rc_scale default = 0.700000 range = < 0.200000 .. 1.000000 >
prop_cover_cfg.tilt_atti_range default = 20.000000 range = < 5.000000 .. 20.000000 >
prop_cover_cfg.tors_gyro_range default = 90.000000 range = < 20.000000 .. 90.000000 >
prop_cover_cfg.vert_vel_up default = 3.000000 range = < 1.000000 .. 4.000000 >
prop_cover_cfg.vert_vel_down default = -2.000000 range = < -3.000000 .. -1.000000 >
...
g_config.avoid_obstacle_limit_cfg.avoid_obstacle_enable default = 1 range = < 0 .. 1 >
user_avoid_enable|g_config.avoid_obstacle_limit_cfg.user_avoid_enable default = 1 range = < 0 .. 1 >
safe_dis|horiz_omni_avoid_min_dis_m default = 1.000000 range = < 0.800000 .. 10.000000 >
...
omni_avoid_fov default = 40.000000 range = < 0.010000 .. 360.000000 >
omni_limit_vel_fov default = 360.000000 range = < 0.010000 .. 360.000000 >
...
g_config.flying_limit.max_radius default = 5000 range = < 15 .. 8000 >
g_config.flying_limit.max_height default = 120 range = < 20 .. 500 >
g_config.flying_limit.radius_limit_enabled|g_config.advanced_function.radius_limit_enabled default = 0 range = < 0 .. 1 >
g_config.flying_limit.min_height default = 20 range = < 1 .. 20 >
min_height_user default = 5 range = < 0 .. 20 >
...
limit_height_rel_by_light default = 3.000000 range = < 0.000000 .. 30.000000 >
g_config.flying_limit.roof_limit_enable default = 0 range = < 0 .. 1 >
vert_up_avoid_min_dis_m default = 1.000000 range = < 0.500000 .. 20.000000 >
...
forearm_led_ctrl|g_config.misc_cfg.forearm_lamp_ctrl default = 239 range = < 0 .. 255 >
...
follow_gimbal_yaw_with_offset_en default = 1 range = < 0 .. 1 >
quick_circle_enable default = 0 range = < 0 .. 1 >
gimbal_yaw_back_to_middle_en default = 1 range = < 0 .. 1 >
...
plant_gain_voltage_comp_enable default = 0 range = < 0 .. 1 >
...
user_test_timer default = 20 range = < 0 .. 2000 >
user_test_esc_factory_test default = 0 range = < 0 .. 1 >
battery_type default = 1 range = < 1 .. 1 >
enSmartBatGH|g_config.voltage2.user_set_smart_bat default = 2 range = < 0 .. 2 >
dji_bat_level_1|g_config.voltage2.level_1_voltage default = 15 range = < 10 .. 100 >
dji_bat_level_2|g_config.voltage2.level_2_voltage default = 10 range = < 10 .. 100 >
...
raw_battery_cell_num|g_config.voltage.battery_cell default = 3 range = < 1 .. 14 >
...
smart_bat_basic_cap default = 10 range = < 0 .. 100 >
level1_smart_battert_gohome|g_config.voltage2.level2_smart_battert_gohome default = 15 range = < 0 .. 100 >
level2_smart_battert_land|g_config.voltage2.level2_smart_battert_land default = 10 range = < 0 .. 100 >
...
emergency_voltage default = 3000 range = < 2500 .. 4000 >
lower_limit_power default = 75 range = < 0 .. 5000 >
enable_new_smart_battery default = 1 range = < 0 .. 2 >
go_home_current default = 7500 range = < 0 .. 65535 >
max_bat_power default = 300 range = < 0 .. 65535 >
...
lowest_hover_power default = 130 range = < 0 .. 65535 >
...
pre_warning_go_home_cap default = 5 range = < 0 .. 100 >
fc_detect_battery_present_support default = 1 range = < 0 .. 1 >
rotate_theta default = 0.000000 range = < -180.000000 .. 180.000000 >
imu_propeller_cali|g_config.cali_switch.imu_propeller_cali default = 2 range = < 0 .. 8 >
...
idle_time|g_config.engine.idle_time default = 1.500000 range = < 1.000000 .. 5.000000 >
...
g_config.takeoff.auto_takeoff_vel default = 0.500000 range = < 0.100000 .. 3.000000 >
...
adv_landing_enable|g_config.landing.adv_landing_enable default = 1 range = < 0 .. 1 >
go_home_height|g_config.go_home.fixed_go_home_altitude default = 30 range = < 20 .. 500 >
...
avoid_enable|g_config.go_home.avoid_enable default = 1 range = < 0 .. 1 >
adv_gohome_enable|g_config.go_home.adv_gohome_enable default = 1 range = < 0 .. 1 >
rtk_go_home_enable default = 0 range = < 0 .. 1 >
cur_height_gohome_enable|g_config.go_home.cur_height_gohome_enable default = 1 range = < 0 .. 1 >
...
g_config.mode_tripod_cfg.rc_scale default = 0.300000 range = < 0.100000 .. 0.400000 >
mode_tripod_cfg_tilt_atti_range default = 25.000000 range = < 10.000000 .. 25.000000 >
g_config.mode_tripod_cfg.tors_gyro_range default = 30.000000 range = < 20.000000 .. 30.000000 >
g_config.mode_tripod_cfg.vert_vel_up default = 1.000000 range = < 0.500000 .. 1.000000 >
g_config.mode_tripod_cfg.vert_vel_down default = -1.000000 range = < -1.000000 .. -0.500000 >
tripod_func_enabled|g_config.mode_tripod_en_cfg.tripod_func_enabled default = 0 range = < 0 .. 1 >
CM_tors_range default = 50.000000 range = < 20.000000 .. 90.000000 >
CM_brake_sensitive default = 10 range = < 10 .. 150 >
mode_gentle_cfg_rc_scale default = 0.700000 range = < 0.100000 .. 1.000000 >
mode_gentle_cfg_tilt_atti_range default = 20.000000 range = < 10.000000 .. 60.000000 >
mode_gentle_cfg_tors_gyro_range default = 75.000000 range = < 20.000000 .. 200.000000 >
mode_gentle_cfg_vert_vel_up default = 3.000000 range = < 1.000000 .. 10.000000 >
mode_gentle_cfg_vert_vel_down default = -2.000000 range = < -10.000000 .. -1.000000 >
g_config.mode_gentle_cfg.tilt_exp_mid_point default = 0.200000 range = < 0.100000 .. 0.900000 >
g_config.mode_gentle_cfg.tors_exp_mid_point default = 0.200000 range = < 0.100000 .. 0.900000 >
g_config.mode_gentle_cfg.lift_exp_mid_point default = 0.200000 range = < 0.100000 .. 0.900000 >
g_config.mode_normal_cfg.rc_scale default = 0.900000 range = < 0.200000 .. 1.000000 >
g_config.mode_normal_cfg.tilt_atti_range default = 20.000000 range = < 5.000000 .. 20.000000 >
g_config.mode_normal_cfg.tors_gyro_range default = 75.000000 range = < 20.000000 .. 90.000000 >
g_config.mode_normal_cfg.vert_vel_up default = 4.000000 range = < 1.000000 .. 4.000000 >
g_config.mode_normal_cfg.vert_vel_down default = -3.000000 range = < -3.000000 .. -1.000000 >
g_config.mode_normal_cfg.tilt_exp_mid_point|g_config.control.tilt_exp_mid_point default = 0.250000 range = < 0.100000 .. 0.900000 >
g_config.mode_normal_cfg.tors_exp_mid_point|g_config.control.yaw_exp_mid_point default = 0.200000 range = < 0.100000 .. 0.900000 >
g_config.mode_normal_cfg.lift_exp_mid_point default = 0.250000 range = < 0.100000 .. 0.900000 >
g_config.mode_sport_cfg.rc_scale default = 0.950000 range = < 0.200000 .. 1.000000 >
mode_sport_cfg_tilt_atti_range|g_config.mode_sport_cfg.tilt_atti_range default = 35.000000 range = < 10.000000 .. 35.000000 >
g_config.mode_sport_cfg.tors_gyro_range default = 130.000000 range = < 20.000000 .. 130.000000 >
mode_sport_cfg_vert_vel_up|g_config.mode_sport_cfg.vert_vel_up default = 4.000000 range = < 1.000000 .. 4.000000 >
mode_sport_cfg_vert_vel_down|g_config.mode_sport_cfg.vert_vel_down default = -3.000000 range = < -3.000000 .. -1.000000 >
g_config.mode_sport_cfg.tilt_exp_mid_point default = 0.350000 range = < 0.100000 .. 0.900000 >
g_config.mode_sport_cfg.tors_exp_mid_point default = 0.350000 range = < 0.100000 .. 0.900000 >
g_config.mode_sport_cfg.lift_exp_mid_point default = 0.300000 range = < 0.100000 .. 0.900000 >
fault_sum_history.fusion_switch default = 0 range = < 0 .. 65535 >
fault_sum_history.master_imu_switch default = 0 range = < 0 .. 65535 >
fault_sum_history.second_imu default = 0 range = < 0 .. 65535 >
fault_sum_history.compass0 default = 0 range = < 0 .. 65535 >
fault_sum_history.gps default = 0 range = < 0 .. 65535 >
fault_sum_history.rtk default = 0 range = < 0 .. 65535 >
fault_sum_history.baro0 default = 0 range = < 0 .. 65535 >
fault_sum_history.voltage default = 0 range = < 0 .. 65535 >
fault_sum_history.wdg_reset default = 0 range = < 0 .. 65535 >
fault_sum_history.cpu_load_oversize default = 0 range = < 0 .. 65535 >
fault_sum_history.acc_disconnect0 default = 0 range = < 0 .. 65535 >
fault_sum_history.acc_stuck0 default = 0 range = < 0 .. 65535 >
fault_sum_history.acc_noise0 default = 0 range = < 0 .. 65535 >
fault_sum_history.gyro_disconnect0 default = 0 range = < 0 .. 65535 >
fault_sum_history.gyro_stuck0 default = 0 range = < 0 .. 65535 >
fault_sum_history.gyro_noise0 default = 0 range = < 0 .. 65535 >
fault_sum_history.baro_disconnect0 default = 0 range = < 0 .. 65535 >
fault_sum_history.baro_drift0 default = 0 range = < 0 .. 65535 >
fault_sum_history.baro_noise0 default = 0 range = < 0 .. 65535 >
fault_sum_history.gyro_acc_drv_config_err0 default = 0 range = < 0 .. 65535 >
